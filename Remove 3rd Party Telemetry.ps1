...
Write-Host "Google Chrome telemetry successfully disabled."

###- Disable Google Update service
Write-Host "Disabling Google Chrome auto-update..."
...
Write-Host "Google Chrome auto-update successfully disabled."
...
Write-Host "Mozilla Firefox telemetry successfully disabled."

###- Disable Media Player telemetry
Write-Host "Disabling Windows Media Player Telemetry..."
...
Write-Host "Windows Media Player telemetry successfully disabled."
...
Write-Host "Microsoft Office telemetry successfully disabled."

###- Disable CCleaner Monitoring
Write-Host "Disabling CCleaner Telemetry..."
...
Write-Host "CCleaner telemetry successfully disabled."

###- Disable Dropbox Update service
Write-Host "Disabling Dropbox auto-update..."
...
Write-Host "Dropbox auto-update telemetry successfully disabled..."
