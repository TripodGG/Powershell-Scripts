# Bypass Edge as Default Handler
# Written by AveYo
# Purpose: Intercept URIs that force-open web links in Microsoft Edge and redirects it to the system's default web browser
...
$vbs = @'
' ChrEdgeFkOff - make start menu web search or widgets links open in your chosen default browser  
